...
export function createListMembershipInvites(deps: {
  ...
  return async function listMembershipInvites(input: {
    accessToken: string;
    gymOrgId: string;
  }) {
...
export function createListMembershipInviteInbox(deps: {
  membershipInvites: MembershipInvitesReader;
}) {
  return async function listMembershipInviteInbox(input: {
    accessToken: string;
  }) {
...
export function createCreateMembershipInvite(deps: {
...
export function createRevokeMembershipInvite(deps: {
  membershipInvites: MembershipInvitesWriter;
}) {
...
export function createAcceptMembershipInvite(deps: {
  membershipInvites: MembershipInvitesWriter;
}) {
