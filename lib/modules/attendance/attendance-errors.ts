...
const ATTENDANCE_ERROR_COPY: Record<string, string> = {
    ...
    ATTENDANCE_FORBIDDEN: 'You need Admin access at this gym to mark attendance.',
...
export function attendanceErrorMessage(code: string, fallbackMessage?: string): string {
    return ATTENDANCE_ERROR_COPY[code] ?? fallbackMessage ?? 'Something went wrong. Please try again.';
}
