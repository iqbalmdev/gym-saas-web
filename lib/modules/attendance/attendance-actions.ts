...
export type AttendanceActionResult = { ok: true } | { ok: false; code: string; message: string };
...
async function requireStaffAdminGym(): Promise<
    { ok: true; accessToken: string; gymOrgId: string } | { ok: false; result: AttendanceActionResult }
> {
...
export async function deskMarkAttendanceAction(input: { clientUserId: string }): Promise<AttendanceActionResult> {
