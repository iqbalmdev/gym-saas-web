...
export type OptionalClassGrant = 'PROGRESS' | 'CALORIES' | 'WEARABLES' | 'DIET_PLANS' | 'WORKOUT_PLANS';
...
export type MembershipInvitesReader = {
    ...
    getMyDataGrants: (input: { accessToken: string; gymOrgId: string }) => Promise<{ dataGrants: MyDataGrants }>;
};
