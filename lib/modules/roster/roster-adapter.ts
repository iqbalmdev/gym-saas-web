...
import { endpoints } from "@/lib/modules/roster/roster-endpoints";
...
function normalizeMember(
  raw: z.infer<typeof memberSchema>,
  gymOrgId: string,
): RosterMember {
  return {
...
function normalizeMembership(
  raw: z.infer<typeof membershipMutationSchema>,
  gymOrgId: string,
): MembershipMutation {
  return {
    membershipId: raw.membershipId,
...
export function createRosterAdapter(
  http: HttpClient,
): RosterReader & RosterWriter {
  return {
