...
const AUTH_ERROR_COPY: Record<string, string> = {
  ...
  GOOGLE_IDENTITY_REQUIRED:
    "That Google account is missing a verified email. Try another account or use email code.",
  OAUTH_CONFIGURATION:
    "Google sign-in is not available right now. Use an email code instead.",
