...
**Vendored from:** https://github.com/fugazi/test-automation-skills-agents/tree/main/skills/playwright-e2e-testing (`3d07e543`).

**gym-saas-web notes:** Prefer this skill for versioned `@playwright/test` specs once the Next.js app exists. Use Playwright MCP for exploratory live sessions. API/OTP contract smokes remain **verify-api-flow** + Postman cloud.
