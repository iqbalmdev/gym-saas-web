...
import {
  ...
  planCapabilityLabel,
  planKindLabel,
} from "@/lib/display/plan-labels";
import {
  createPlanAction,
  deletePlanAction,
  setPlanActiveAction,
} from "@/lib/features/plans/actions";
import type { MembershipPlan, PlanKind } from "@/lib/ports/plans";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-[var(--color-fg-muted)]">
          Base memberships and add-ons (Trainer coaching). Unpaid members stay
          entitled unless you manually block check-in later.
        </p>
      </div>
      ...
      <div className="flex flex-wrap gap-2">
        {(
          ...
          const href =
            value === "ALL" ? "/admin/plans" : `/admin/plans?kind=${value}`;
              ...
              >
                <div className="min-w-0 space-y-1">
                  ...
                  <p className="text-xs text-[var(--color-fg-muted)]">
                    ...
                    {plan.kind === "ADDON"
                      ? ` · ${planCapabilityLabel(plan.capability)}`
                      : ""}
