...
import { deskMarkAttendanceAction } from "@/lib/features/attendance/actions";
    ...
    <div className="space-y-6">
      <div>
        ...
        <p className="mt-2 max-w-2xl text-sm text-[var(--color-fg-muted)]">
          Desk-mark members for today ({day}). Entitlement follows subscription
          dates, not payment status.
        </p>
      </div>
              ...
              >
                <div>
                  ...
                  <p className="text-xs text-[var(--color-fg-muted)]">
                    {item.recordedBy === "ADMIN" ? "Desk" : "Self"} ·{" "}
