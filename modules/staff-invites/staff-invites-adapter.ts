...
import { endpoints } from '@/modules/staff-invites/staff-invites-endpoints';
import type { HttpClient } from '@/lib/api/client';
import type { StaffInvitesReader, StaffInvitesWriter } from '@/modules/staff-invites/staff-invites-ports';
...
export function createStaffInvitesAdapter(http: HttpClient): StaffInvitesReader & StaffInvitesWriter {
    return {
