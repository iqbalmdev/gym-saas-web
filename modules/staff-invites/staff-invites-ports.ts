...
export type StaffInvitesWriter = {
    ...
    revoke: (input: { accessToken: string; inviteId: string }) => Promise<{ staffInvite: StaffInvite }>;

    accept: (input: { accessToken: string; inviteId: string }) => Promise<{ staffInvite: StaffInvite }>;
};
