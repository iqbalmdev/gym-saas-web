...
export type PlansReader = {
    ...
    get: (input: { accessToken: string; gymOrgId: string; planId: string }) => Promise<{ plan: MembershipPlan }>;
};
...
export type PlansWriter = {
    ...
    softDelete: (input: { accessToken: string; gymOrgId: string; planId: string }) => Promise<void>;
};
