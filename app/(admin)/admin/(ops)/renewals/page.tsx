import { RenewalsAdminPanel } from "@/components/admin/renewals-admin-panel";
import { createAppServices } from "@/lib/api/composition";
import { ApiClientError } from "@/lib/api/errors";
import { getSession, isStaffSession } from "@/lib/auth/session";
import { subscriptionErrorMessage } from "@/lib/display/subscription-errors";
import { listStaffGymOrgs } from "@/lib/features/gym-orgs/list-staff-gym-orgs";
import type { RenewalDueItem } from "@/lib/ports/subscriptions";
