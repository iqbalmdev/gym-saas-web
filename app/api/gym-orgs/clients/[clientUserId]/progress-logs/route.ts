...
import { listStaffClientProgressLogsForGym } from '@/modules/profile/profile-queries';
...
export async function GET(_request: Request, context: RouteContext) {
    ...
    try {
        const result = await listStaffClientProgressLogsForGym({
        ...
        return NextResponse.json({ progressLogs: result.data });
    } catch (error) {
