...
import { listMyProgressLogsForSession } from '@/modules/profile/profile-queries';
...
export async function GET() {
    ...
    try {
        const progressLogs = await listMyProgressLogsForSession({ accessToken: gate.session.accessToken });
