...
export default async function LoginPage() {
    ...
    return (
        <div className="space-y-6">
            <div>
                <p className="text-xs font-medium tracking-wide text-[var(--color-fg-muted)] uppercase">Gym SaaS</p>
                <h1 className="mt-1 text-2xl font-semibold text-[var(--color-fg)]">Sign in</h1>
